...
== Usage
  count_shop = ShopifyAPI.credit_used
  limit_shop = ShopifyAPI.credit_limit
...
== Additional method for ensuring a call completes.
...
The block will be retried up to 5 times, and will sleep for 60 seconds between retries. This allows for the full 5 minutes to pass before the limit is reset.
